...
*/
let kIssuer: String = "https://identityserver-52520.azurewebsites.net";
...
*/
let kClientID: String? = "ios";
/**
 The OAuth redirect URI for the client @c kClientID.

 For client configuration instructions, see the [README](https://github.com/openid/AppAuth-iOS/blob/master/Examples/Example-iOS_Swift-Carthage/README.md).
*/
let kRedirectURI: String = "com.identity.test://callback";
/**
...
extension AppAuthExampleViewController {
    ...
    @IBAction func openURL(_ sender: Any) {
        ...
        guard let url = URL(string: "https://applesignintest.azurewebsites.net") else { return }
